...
*Если вы найдёте какие-то части перевода недостаточно корректными, особенно в плане терминов, или столкнётесь с любыми ошибками - дайте мне, пожалуйста, знать. Я практически не общаюсь с русским сообществом Erlang\Elixir, поэтому могу быть не в курсе устоявшейся терминологии.*

*Сочетание цветов на некоторых иллюстрациях и меня напрягает, но решил не менять схему автора, только локализовать.*
